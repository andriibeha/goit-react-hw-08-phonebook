    ...
    return (
        <>
            <form onSubmit={handleSubmit} >
                ...
                <p className="my-3 text-center" >Please fill in this form to create an account.</p>
                <div className="flex flex-col my-3 items-center border bg-gray-200 ">
                    <label className="my-2" htmlFor={inputEmailId}><b>Email</b></label>
                    ...
                    <label className="my-2" htmlFor={inputPasswordId}><b>Password</b></label>
                    <input onInput={handleInputChange}
                        className="border rounded-xl px-2 w-1/2 "
                        value={password}
                        type="password"
                    ...
                    <label className="my-2" htmlFor={inputNameId}><b>Name</b></label>
                    <input onInput={handleInputChange}
                ...
                <p className="text-center">
                    ...
                    <NavLink className="text-sky-500 underline ml-1" to="/login">Sign in</NavLink>.
                </p>
